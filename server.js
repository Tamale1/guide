...
app.get('/api/:alienName',(request, response)=>{
    const aName = request.params.alienName.toLocaleLowerCase()
    if (aliens[aName]) {
        response.json(aliens[aName])
...
app.listen(process.env.PORT ||PORT,()=>{
    console.log('server runnig after you better stop and catch it if you so wish');
})
